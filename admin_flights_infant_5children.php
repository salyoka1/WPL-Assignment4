...
<head>
    <meta charset="UTF-8">
    <title>Admin: Flights With Infant & ≥5 Children</title>
    <link rel="stylesheet" href="mystyle.css">
</head>
<body>
<div class="header">
    <h1>Admin: Flights With At Least 1 Infant and ≥5 Children</h1>
...
if($result && $result->num_rows>0){
    ...
    echo '</table>';
}else echo "<p>No flights match the criteria.</p>";
?>
</div>
</body>
</html>
